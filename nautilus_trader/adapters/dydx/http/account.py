...
from nautilus_trader.adapters.dydx.endpoints.account.address import (
...
from nautilus_trader.adapters.dydx.endpoints.account.orders import (
...
from nautilus_trader.adapters.dydx.endpoints.account.subaccount import (
...
class DYDXAccountHttpAPI:
    ...
    def __init__(
        ...
        self._endpoint_get_perpetual_positions = DYDXGetPerpetualPositionsEndpoint(
            client
        )
    ...
    async def get_adress_subaccounts(
        ...
        """
        return await self._endpoint_get_address.get(
            DYDXGetAddressGetParams(address=address)
        )
